...
namespace GravitySimulator2D
{
    ...
    public class Perlin2D
    {
        ...
        public float Noise(Vector2 fxy)
        {
            return Noise(fxy.X, fxy.Y);
        }
        ...
        public float Noise(Vector2 fxy, int octaves, float persistence = 0.5f)
        {
            return Noise(fxy.X, fxy.Y, octaves, persistence);
        }
    }
}
